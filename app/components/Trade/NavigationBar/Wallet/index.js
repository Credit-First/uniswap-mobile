      ...
      <Button
        ...
        <View style={styles.energyWrapper}>
          <View style={styles.item}>
            <Icon name={ICON_NAMES.ENERGY} size={styles.icon.width} />
      ...
      <Button
        ...
        <View style={styles.coinWrapper}>
          <View style={[styles.item, styles.itemGap]}>
            <BNBIcon width={styles.icon.width} height={styles.icon.height} />
            <Text style={styles.text}>
              {walletBalance?.bnb.presentationValueShort ?? '-'}
            </Text>
          </View>
          <View style={[styles.item, styles.itemGap]}>
            <IGUPIcon width={styles.icon.width} height={styles.icon.height} />
            <Text style={styles.text}>
              {walletBalance?.igup.presentationValueShort ?? '-'}
            </Text>
          </View>
          <View style={styles.item}>
            <IGUIcon width={styles.icon.width} height={styles.icon.height} />
            <Text style={styles.text}>
