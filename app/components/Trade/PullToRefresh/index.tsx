...
const textDefaultPulling = i18n.t('pullToRefresh.pullText');
const textDefaultReleasing = i18n.t('pullToRefresh.releaseText');
const textDefaultLoading = i18n.t('pullToRefresh.loadingText');
...
const PullToRefresh: React.FC<IProps> = ({
    renderItem,
    onRefresh,
    refreshing,
