...
const TelosEVMAccountScreen = props => {
  ...
  // var runOnce = 0;
  const name =  "TELOSEVM:" + account.accountName;
  var usdValue = 0;
        ...
        fetch(fioEndpoint + '/v1/chain/get_pub_address', {
          ...
          .catch(error =>
            log({
              ...
              cause: error,
              location: 'TelosEVMAccountScreen',
            }),
          );
      }
    });
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.inner}>
        ...
        />
        <View style={styles.spacer} />
        <KText>Balance: {accountBalance} TLOS</KText>
...
export default connectAccounts()(TelosEVMAccountScreen);
